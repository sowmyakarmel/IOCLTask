...
<body>       
  ...
  <table align="center" width="300px" style="background-color:#EDF6EA;border:1px solid #000000;">
            ...
            <tr>
                <td>Employee Name</td>
                <td><input type="text" name="empname" value="<%=empname2%>"></td>
            </tr>
            <tr>
                <td>Password</td>
                <td><input type="text" name="password" value="<%=emppass2%>"></td>
            </tr>
            <tr>
                <td>Department </td>
                <td><input type="text" name="department" value="<%=empdept2%>"></td>
            </tr>
            <tr>
                <td>Designation</td>
                <td><input type="text" name="designation" value="<%=empdesg2%>"></td>
            </tr>
            <tr>
                <td>Mobile Number</td>
                <td><input type="text"  name="mobile" value="<%=empmob2%>"></td>
            </tr>
                <td></td>
